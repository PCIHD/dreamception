"""
Django settings for dreamception project.
...
SECRET_KEY = 'foy963b4l)#@l10fn5d=dzysg0+sj2zam@vtu1vrcg-w7j6!s$'
...
ROOT_URLCONF = 'dreamception.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [TEMPLATE_DIR,Deepdream_Templates],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'dreamception.wsgi.application'
